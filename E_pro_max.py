...
while(True):
    ...
    if mode== 2:
        ...
        renew_board()
        UartSendDate([real_edge_rect_corners[0][0],real_edge_rect_corners[0][1],
                      real_edge_rect_corners[1][0],real_edge_rect_corners[1][1],
                      real_edge_rect_corners[2][0],real_edge_rect_corners[2][1],
                      real_edge_rect_corners[3][0],real_edge_rect_corners[3][1]])#边框坐标
